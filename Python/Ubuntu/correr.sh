...
then
    ...
    echo "alias ipython3-${DOCKER_NAME}='sudo docker run -v \$PWD:/home/work --expose=8899 -p 8899:8899 -w /home/work -it ${DOCKER_NAME} ipython3'" >> ~/.bash_aliases
    echo "alias bash-${DOCKER_NAME}='sudo docker run -v \$PWD:/home/work --expose=8899 -p 8899:8899 -w /home/work -it ${DOCKER_NAME} /bin/bash'" >> ~/.bash_aliases
    exit 0
fi
